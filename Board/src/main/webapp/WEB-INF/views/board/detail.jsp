	...
	<section>
		...
		<div class="container col-8" id="boardRead">
			<div id="boardTopbtn">
				...
				<!-- </c:if> -->
                <a class="btn btn-secondary" href="/board"type="button" style="float:right;">목록으로</a>
				<br/>
				<br/>
			</div>
			...
			<div id="boardReadHeader">	 
				...
				<div id="boardProfile">
                    ...
                    <div id="boardInfo">
                        <h6 id="boardInfo1">
                            게시글 번호 : ${board.id}, 작성자 : ${board.writerId}
                            
                        </h6>
                        <h6 id="boardInfo2">
                            작성일시 : ${board.regDt.format(DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss"))},
                            수정일시 : ${board.modDt.format(DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss"))}
                        </h6>
                    </div>
			...
			<div id="boardReadFooter">
                ...
                <div id="file_wrapper">
                    ...
                    </svg>첨부파일 : <a href="/worldcup/${boardInfo.file}" download>filename</a>                        
                </div>
			...
			<!-- 게시판 댓글 -->
            <div class="container">
                <h5 class="mt-5"><b>댓글 ${replyList.size()}</b></h5>
                ...
                <ul class="list-group">
                    <c:forEach items="${replyList}" var="nthReply">
                    	<li class="list-group-item"><strong>${nthReply.writerId}</strong>   ${nthReply.content}</li>
                    </c:forEach>
                </ul>
...
// 				type : "POST",
// 				data : "category=${category}" + "&${category}Idx="+${boardInfo.boardIdx},
// 				success : function(result) {
// 					alert("글이 삭제 되었습니다.");
// 					window.location = document.referrer;
// 				},
